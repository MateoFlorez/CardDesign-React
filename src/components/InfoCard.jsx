export default function InfoCard() {
  return (
    <div className="bg-slate-100 w-full mt-20 h-4/5 flex-col justify-center px-11 z-20">
      ...
      <div className="px-1 rounded-lg h-10 grid items-center transition ease-in-out delay-150 hover:bg-slate-300 hover:-translate-y-1 hover:scale-105 hover:shadow-lg duration-300">
        <div className="grid grid-cols-3 justify-center items-center">
          <p>Oct.21, 2021</p>
          <p>Pro Annual</p>
          <button className="w-24 border border-slate-400 rounded-md h-8 transition linear duration-500 hover:border-black hover:bg-black hover:text-white">
            Download
          </button>
        </div>
      </div>
