export default function RightSide() {
  return (
    <div className="bg-slate-100 w-72 mt-20 h-4/5 flex justify-center px-7 rounded-r-2xl">
      <div className="bg-orange-500 h-44 mt-28 rounded-2xl w-52 p-4 text-white text-center">
        ...
        <button className="w-fit font-semibold px-1 border border-white rounded-md h-8 mt-4">
          Cancel subscription
        </button>
      </div>
    </div>
